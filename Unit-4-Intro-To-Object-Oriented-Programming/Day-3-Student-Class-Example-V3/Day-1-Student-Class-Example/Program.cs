...
//  ClassName objName = new ClassName(initial-name, initial-scores)    
    ...
    //If given a no string value, it trys to convert it to string 
    //The ways it trys to convert to a string:
    //
    //1. Looks at the datatype of what you are trying to dsiplay
    //2. It determines if there is amethod available to convert the 
