 ...
 *******************************************************************************************/
     ...
     *
     * Getter and setter are special methods to allow a class controlled access to the data
     *
     * Getters =  return the value in our data members
     * Setters = alllow the chaning of data members
     *
    ...
    {
        return studentName;  // return the value of this private data member
    }

    public List<Double> StudentName()
    {
        return testScores; // return the value of this private data member
    }
     ...
     *******************************************************************************************/
    // We need to provide a ToString() method to return a string respresentation of the data

    //override - indicates you are a providing a method that overrides standard C# behaviour
    ...
    {
        //To round a double value to decimal places use Math.Round(value, 3 decimal- palces)
