...
class Program
    {
        ...
        static bool moreInput()
        {
            ...
            do
            {
                ...
                if (firstChar == "Y")
                {
                    getInput = false;     //Done getting inpup - set loop control var to false - end loop
                    isThereInput = true;
                }
                else
                {
            ...
            // while(getInput == true0 // altenate way of coding
            // its not neccessary when you have bool variabe can only true or false
